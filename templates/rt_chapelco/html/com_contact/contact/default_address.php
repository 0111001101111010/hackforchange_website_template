 ...
 */
?>
<p class="shrink-for-contact">
	<span class="paneltitle nomarginbottom">Contact HackForAthens.org</span>
</p>
...
<?php if ($this->contact->email_to && $this->params->get('show_email')) : ?>
	<p>
		<span class="contact-emailto text-icon email">
...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	<p>
		<span class="contact-telephone text-icon phone">
