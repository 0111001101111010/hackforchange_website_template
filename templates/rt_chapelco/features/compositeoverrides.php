<?php
 /**
  * @version   $Id: compositeoverrides.php 7933 2013-02-27 20:50:40Z josh $
...
class GantryFeatureCompositeOverrides extends GantryFeature {
	...
	function init() {
        ...
        if (defined('ROKCOMMON') && class_exists('RokCommon_Composite')){
            RokCommon_Composite::addPackagePath('mod_rokgallery', JPATH_SITE . '/templates/rt_chapelco/overrides/mod_rokgallery/templates',20);
        }
	}
